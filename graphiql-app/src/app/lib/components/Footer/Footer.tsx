            ...
            <div className={"row"}>
                <div className={"col-12"}>
                    <ul className={"list-group list-group-horizontal navbar-rss ul-footer-rss"} style={{"overflow": "hidden"}}>
                        <li className={"list-group-item navbar-rss"} style={{"width": "130px"}}>
                        ...
                        <li className={"list-group-item navbar-rss"} style={{"width": "300px"}}>
                            {t("project")}:<span className={"ms-1"} style={{"fontWeight": "bolder"}}>REST/GraphiQL Client</span>
                        </li>
                    </ul>
                </div>
            </div>
