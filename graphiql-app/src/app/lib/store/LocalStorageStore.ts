...
import {HistoryPayload, HistoryLocalStorageRecord, HistorySavedItem, HistoryRecordType} from "@app/lib/types/types";
import {notEmptyString, safeString} from "@app/lib/utils/stringUtils";


export type AppLocalStorage = {
    addToHistory: (recordType: HistoryPayload, type: HistoryRecordType, userId: string) => void;
...
export function getAppLocalStorage(): AppLocalStorage {
    ...
    function addToHistory(payload: HistoryPayload, type: HistoryRecordType, userId: string) {
