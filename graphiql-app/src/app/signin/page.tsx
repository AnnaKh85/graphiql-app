...
import {consoleLogError, consoleLogValuesError} from "@app/lib/utils/consoleUtils";
            ...
            <div className={"card-body"}>
                ...
                <form>
                    ...
                    <div className={"mb-3"}>
                        ...
                        <input type="email" className="form-control" id="inputEmail" placeholder={t("email")} value={emailValue} onChange={e => setEmailValue(e.target.value)} data-testid="inputEmail-test" />
                    </div>
                    <div className={"mb-3"}>
                        <label htmlFor="inputPass" className={"form-label"}>{t("password")}</label>
                        <input type="password" className="form-control" id="inputPass" placeholder={t("password")} value={passValue} onChange={e => setPassValue(e.target.value)} data-testid="inputPass-test" />
                    </div>
                </form>
            </div>
